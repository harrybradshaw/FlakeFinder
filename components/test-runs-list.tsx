            ...
            <Card className="hover:bg-accent/50 transition-colors cursor-pointer overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-1">
                        ...
                        {run.project_display && run.project_display !== 'Default Project' && (
                          <Badge 
                            variant="outline" 
                            className="text-xs"
                            style={{ 
                        ...
                        <Badge variant="secondary" className="text-xs">
                          {run.trigger_icon && <span className="mr-1">{run.trigger_icon}</span>}
              ...
              {run.uploaded_filename && (
                <div className="px-4 py-1.5 bg-muted/20 border-t text-xs text-muted-foreground">
                  <span className="font-mono truncate">{run.uploaded_filename}</span>
                </div>
              )}
            </Card>
          </Link>
